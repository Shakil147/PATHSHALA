			...
			<div class="container">
				...
				<div class="col-sm-8 col-md-9">
					<div class="academic-content-box">
						...
						<h3>PRESCHOOL CURRICULUM HIGHLIGHTS</h3>
						<p>It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
						<ul class="curriculum-highlights">
							<li class="col-md-6"><i class="fa fa-check"></i>Basics of letter formation</li>
							<li class="col-md-6"><i class="fa fa-check"></i>Basics of math components</li>							
							<li class="col-md-6"><i class="fa fa-check"></i>Social and emotional component</li>
							<li class="col-md-6"><i class="fa fa-check"></i>Basics of letter formation</li>
							<li class="col-md-6"><i class="fa fa-check"></i>Basics of letter formation</li>
							<li class="col-md-6"><i class="fa fa-check"></i>Basics of math components</li>	
							<li class="col-md-6"><i class="fa fa-check"></i>Spiritual learning</li>
							<li class="col-md-6"><i class="fa fa-check"></i>Writing and phonics</li>
						</ul>
					</div>
				</div>
			</div>
