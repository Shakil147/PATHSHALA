			...
			<div class="container">
				...
				<div class="col-md-2 col-sm-6 footer-item">
					...
					<div class="quick-link-box">
						<a href="#{{ url('/academic') }}"><i class="fa fa-graduation-cap"></i>Academics</a>
						<a href="#{{ url('/admission') }}"><i class="fa fa-users"></i>Admission</a>
						<a href="#{{ url('/events') }}"><i class="fa fa-calendar"></i>Events</a>
						<a href="#{{ url('/') }}"><i class="fa fa-thumbs-up"></i>Campus Life</a>
					</div>
				</div>
