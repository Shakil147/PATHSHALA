			...
			<div class="col-sm-5 notification-area">
				<ul class="top-nav-list">
					...
					<li class="message dropdown">
						...
						<ul class="dropdown-menu notification-list">
							<li>
								<div class="list-msg">
									<div class="col-xs-2 image clear-padding">
										<img src="{{ asset('scource')}}/dashboard/assets/img/parent/parent2.jpg" alt="user" />
									</div>
									<div class="col-sm-10 desc">
							...
							<li>
								<div class="list-msg">
									<div class="col-xs-2 image clear-padding">
										<img src="{{ asset('scource')}}/dashboard/assets/img/parent/parent1.jpg" alt="user" />
									</div>
									<div class="col-sm-10 desc">
					...
					<li class="user dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<span><img src="{{ asset('scource')}}/dashboard/assets/img/parent/parent2.jpg" alt="user"> {{ Auth::user()->name }} <span class="caret"></span></span>
						</a>
						<ul class="dropdown-menu notification-list">
							<li>
